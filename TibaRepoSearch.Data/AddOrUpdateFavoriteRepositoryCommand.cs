...
public class AddOrUpdateFavoriteRepositoryCommand : IAddOrUpdateFavoriteRepositoryCommand
{
    ...
    public AddOrUpdateFavoriteRepositoryCommand(IFavoriteRepositoryData data, IDbContextFactory<FavoriteRepositoriesContext> contextFactory, ILogger<AddOrUpdateFavoriteRepositoryCommand> logger)
    {
        ...
        _logger = logger;
        _logger.LogTrace("[AddOrUpdateFavoriteRepositoryCommand..ctor] {data};{contextFactory} OK", data, contextFactory);
    }
    ...
    public async Task ExecuteAsync()
    {
        try
        {
            ...
            _logger.LogTrace("[AddOrUpdateFavoriteRepositoryCommand.ExecuteAsync]  OK");
        }
        catch (Exception ex)
        {
            _logger.LogTrace("[AddOrUpdateFavoriteRepositoryCommand.ExecuteAsync]  {Message}", ex.Message);
            throw;
        }
    }
}